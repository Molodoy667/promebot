...
import TelegramAuthSettings from "@/components/admin/TelegramAuthSettings";
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6">
          <h1 className="text-3xl font-bold">Telegram Auth</h1>
          <p className="text-muted-foreground mt-2">
            Налаштування автентифікації через Telegram
          </p>
        </div>
