      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        {stats && (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {/* Total Posts - only for plagiarist */}
            {serviceType === 'plagiarist' && activeTab === 'all' && (
                ...
                <CardContent className="p-3">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-muted-foreground truncate">Всього постів</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="glass-effect col-span-2">
                <CardContent className="p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-xl font-bold text-amber-500">{stats.scheduledPosts}/10</div>
                      <p className="text-xs text-muted-foreground truncate">В черзі</p>
                    </div>
                    <Button 
                      variant="outline" 
                      size="sm"
            ...
            <Card className="glass-effect">
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xl font-bold text-destructive">{stats.failedPosts}</div>
                    <p className="text-xs text-muted-foreground truncate">Невдалі</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect">
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xl font-bold text-primary">{stats.todayPosts}</div>
            ...
            <Card className="glass-effect">
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xl font-bold">{stats.weekPosts}</div>
            ...
            <Card className="glass-effect">
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xl font-bold">{stats.monthPosts}</div>
            ...
            <Card className="glass-effect">
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xl font-bold">{stats.avgPostsPerDay}</div>
                    <p className="text-xs text-muted-foreground truncate">Середньо/день</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect">
              <CardContent className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xl font-bold">{stats.sourcesCount}</div>
                    <p className="text-xs text-muted-foreground truncate">{serviceType === 'ai' ? 'Категорій' : 'Джерел'}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-bold truncate">
                      {stats.lastPostDate 
                        ? new Date(stats.lastPostDate).toLocaleString("uk-UA", {
                            day: "2-digit",
                            month: "2-digit",
                            year: "numeric",
                            hour: "2-digit",
