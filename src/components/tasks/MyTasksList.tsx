              ...
              <>
                {(task.budget === 0 || !task.budget) ? (
                  <div className="pt-2 border-t">
                    <div className="flex items-center justify-center text-sm bg-red-50 dark:bg-red-950 py-2 rounded-md border border-red-500/30">
                      <span className="text-red-600 font-medium">⚠️ Будь ласка, поповніть бюджет для запуску</span>
                    </div>
                  </div>
                ) : (
