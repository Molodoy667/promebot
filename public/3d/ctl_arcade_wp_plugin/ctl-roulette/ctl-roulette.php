<?php
    /*
    Plugin Name: CTL Arcade - Roulette
    Plugin URI: http://www.codethislab.com/
    Description: Roulette for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeRoulette {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-roulette";
        private $_szPluginName              = "Roulette";
        private $_szAspectRatio             = "5:4";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "bet, casino, casino game, gambling, game, instant win, mobile, poker, roulette, roulette game, sweepstakes, table, texas, wheel";
    ...
    $g_oCTLArcadeRoulette =  new CTLArcadeRoulette();
