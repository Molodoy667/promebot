-- Оновлюємо функцію create_notification для автоочищення старих логів входу
...
COMMENT ON FUNCTION create_notification IS 'Створює сповіщення та автоматично видаляє старі логи входу (залишає тільки 10 останніх для кожного користувача)';
